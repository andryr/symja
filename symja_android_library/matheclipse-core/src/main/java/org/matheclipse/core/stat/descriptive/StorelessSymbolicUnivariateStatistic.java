...
/**
 * Extends the definition of {@link SymbolicUnivariateStatistic} with
...
public interface StorelessSymbolicUnivariateStatistic extends SymbolicUnivariateStatistic {
	 ...
	 * values in the values array. Does not clear the statistic first -- i.e., the
	 * values are added <strong>incrementally</strong> to the dataset.
	 * 
	 * @param values
